...
priority: high
effort: XL
tags: [software, agents, workflow, kanban, epic]
links:
  - target: adr-0019
    relation: implements
  - target: adr-0020
...
- Backlog item dependencies (blocked_by/blocks) — correctness fix for sw_pull_next
- Review outcome capture (sw_review) — feedback loop
- Work session log — session context for handoffs
