...
TASK_WORKFLOW = {
    ...
    "field": "status",
    "transitions": [
        {"from": "open", "to": "claimed", "requires": "write", "description": "Claim a task for work"},
        {"from": "claimed", "to": "in_progress", "requires": "write", "description": "Start working on the task"},
        {"from": "in_progress", "to": "blocked", "requires": "write", "description": "Mark task as blocked"},
        {"from": "in_progress", "to": "review", "requires": "write", "description": "Submit task for review"},
        {"from": "in_progress", "to": "done", "requires": "write", "description": "Mark task as done"},
        {"from": "in_progress", "to": "failed", "requires": "write", "description": "Mark task as failed"},
        {"from": "blocked", "to": "in_progress", "requires": "write", "description": "Resume blocked task"},
        {"from": "review", "to": "done", "requires": "write", "description": "Approve and complete task"},
        {"from": "review", "to": "in_progress", "requires": "write", "description": "Send task back for more work"},
        {
            "from": "failed",
            "to": "open",
            "requires": "write",
